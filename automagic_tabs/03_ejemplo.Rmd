...
Se generan gráficos para evaluar los modelos. En este caso, se utiliza la función **check_model()** del paquete **{performance}** 📦 para evaluar el fctor de inflación de la varianza (o VIF por sus siglas en inglés).
